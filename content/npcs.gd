...
#   on_attacked   String   — reaction when first attacked: "retaliate" or "flee"
...
const DATA: Dictionary = {
	"merchant": {
		...
		"is_merchant": true, "buy_mult": 0.65, "sell_mult": 1.40, "on_attacked": "flee",
		"dialogue": [
	...
	"village_elder": {
		...
		"is_merchant": false, "on_attacked": "flee",
		"dialogue": [
	...
	"smith": {
		...
		"is_merchant": true, "buy_mult": 0.50, "sell_mult": 1.60, "on_attacked": "retaliate",
		"dialogue": [
	...
	"weaver": {
		...
		"is_merchant": true, "buy_mult": 0.55, "sell_mult": 1.45, "on_attacked": "flee",
		"dialogue": [
	...
	"priest": {
		...
		"base_hp": 9, "defense": 0, "power": 1, "level": 1, "attack_speed": 1.0,
		"is_merchant": false, "on_attacked": "retaliate",
		"dialogue": [
	...
	"dyer": {
		...
		"base_hp": 8, "defense": 0, "power": 1, "level": 1, "attack_speed": 1.0,
		"is_merchant": true, "buy_mult": 0.50, "sell_mult": 1.55, "on_attacked": "flee",
		"dialogue": [
	...
	"foreign_trader": {
		...
		"base_hp": 11, "defense": 0, "power": 1, "level": 1, "attack_speed": 1.0,
		"is_merchant": true, "buy_mult": 0.60, "sell_mult": 1.50, "on_attacked": "flee",
		"dialogue": [
	...
	"caravan_guard": {
		...
		"is_merchant": true, "buy_mult": 0.45, "sell_mult": 1.55, "on_attacked": "retaliate",
		"dialogue": [
	...
	"gazelle": {
		...
		"is_merchant": false, "is_wildlife": true, "on_attacked": "flee",
	...
	"onager": {
		...
		"is_merchant": false, "is_wildlife": true, "is_mountable": true, "on_attacked": "flee",
	...
	"donkey": {
		...
		"base_hp": 11, "defense": 0, "power": 1, "level": 1, "attack_speed": 1.0,
		"is_merchant": false, "is_wildlife": false, "is_mountable": true, "on_attacked": "flee",
	...
	"hyena": {
		...
		"is_merchant": false, "is_wildlife": true, "on_attacked": "retaliate",
